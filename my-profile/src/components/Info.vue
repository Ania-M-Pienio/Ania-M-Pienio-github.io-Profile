<template> 
          <div class="info-container">  
            <div 
              align="center"
              style="paddingTop: 10px; backgroundColor: #68696b;"
            ...
            > 
              <div 
                ...
                <div class="display-2 font-weight-light mb-4" style="width: 800px; color: #ededed; marginLeft: 30px;  marginRight: 30px;"> {{Section.title}} </div> 
              ...
              <div class="circleButtons">
                ...
                <v-btn 
                  ...
                  >
                    <v-icon
                      :color="Section.number == titles.indexOf(title) ? 'red lighten-4' : 'grey darken-2'"
                    >
                      mdi-moon-full
                    </v-icon> 
...
<style scoped>
  ...
  .buttonCircle:hover {
    background-color: rgba(255, 182, 193, 0.387);
  }
...
export default {
  ...
  watch: {
    portfolio: function(newVal, oldVal) {
      if (newVal == true) {
